...
* $Revision: 5433 $ (v4.040.05.011646)
* $Date: 2016-07-05 00:52:14 +0530 (Tue, 05 Jul 2016) $
*
* History:
    ...
    uint16_t * pVersionStringLen)
{
   ...
   if (pProductVer);
    ...
    wCopyLen = sizeof(szNxpNfcRdLib_VER_FILEDESCRIPTION)/sizeof(szNxpNfcRdLib_VER_FILEDESCRIPTION[0]);
    ...
    else
    {
        ...
        memcpy(pVersionString, szNxpNfcRdLib_VER_FILEDESCRIPTION, wCopyLen); /* PRQA S 3200 */
