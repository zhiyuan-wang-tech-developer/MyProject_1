...
extern phStatus_t phhalHw_Pn5180_Instr_ReadE2Prom(
                                        ...
                                        )
{
    ...
    uint16_t timeout = PHPAL_I14443P3A_SELECTION_TIME_US + PHPAL_I14443P3A_EXT_TIME_US;
    timeout += PHPAL_I14443P4_EXT_TIME_US;
    timeout += PHPAL_I14443P4A_SW_EXT_TIME_US;
...
//    
//    uint8_t eeprom_map[256] = {0};
//    uint8_t addr;
//    for( addr = 0; addr < 254; addr++ ){
//        phhalHw_Pn5180_Instr_ReadE2Prom( pDataParams->pHalDataParams, addr, &eeprom_map[addr],  1) ;
//    }
//    
