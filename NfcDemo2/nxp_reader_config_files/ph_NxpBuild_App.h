...
#define NXPBUILD__PH_PLATFORM                               /**< Embedded Platform Porting and Abstraction Component included. Used for LPC_XXX, Kinetis_XXX,Raspberry_XXX,iMX_XXX etc. */
    ...
    #define NXPBUILD__PH_PIC32MX                         /**< Host Controller PIC32MX (added by zhiyuan)*/
    ...
    //#define NXPBUILD__PH_UDOO_NEO                         /**< Host Controller udoo-neo */
    ...
    #if defined(NXPBUILD__PH_PIC32MX)
        /* Host Controller PIC32MX - Front End HAL Interface ie. Bus Abstraction Layer. Define only one of the below */
        #define NXPBUILD__PHBAL_REG_PIC32MX_SPI             /**< PIC32MX SPI BAL Component is included. */
        //#define NXPBUILD__PHBAL_REG_PIC32MX_I2C           /**< PIC32MX I2C BAL Component is included. */
    #endif
        ...
        //#define NXPBUILD__PHBAL_REG_LPCOPEN_I2C           /**< LPCOpenStack I2C BAL Component is included. */
    #endif
...
#define NXPBUILD__PHAC_DISCLOOP_SW                          /**< Discovery Loop Activity SW Component is included. */
            ...
            defined (NXPBUILD__PHHAL_HW_PN7462AU)
            #define NXPBUILD__PHAC_DISCLOOP_LPCD       /**< SRC to enable LPCD is included. (WANG)*/
    #endif
...
#define NXPBUILD__PH_KEYSTORE_SW                                /**< KeyStore SW Component is included. */
...
/*********************************************************************************************************************************************************************************/
    ...
    #endif
    #define NXPBUILD__PHAL_MFUL_SW                              /**< AL Mifare Ultrlight SW Component is included (WANG)*/
    #define NXPBUILD__PHAL_MFDF_SW                              /**< AL Mifare DesFire SW Component is included (WANG)*/
