...
* $Revision: 6235 $ (v4.040.05.011646)
* $Date: 2016-09-30 12:06:20 +0530 (Fri, 30 Sep 2016) $
*
* History:
...
#define NXPBUILD__PH_PLATFORM                               /**< Embedded Platform Porting and Abstraction Component included. Used for LPC_XXX, Kinetis_XXX,Raspberry_XXX,iMX_XXX etc. */
    ...
    #ifdef CPU_MK81FN256xxx15
      #define NXPBUILD__PH_KINETIS_K81
    #endif
    ...
    #if defined (NXPBUILD__PH_KINETIS_K82) || defined (NXPBUILD__PH_KINETIS_K81)
