...
void (* const g_pfnVectors[])(void) = {
    ...
    CLIF_IRQHandler,             //  0 - GPIO pin interrupt 0
    ...
    TIMER0_IRQHandler,            // 16 - CT16B0 (16-bit Timer 0)
    TIMER1_IRQHandler,            // 17 - CT16B1 (16-bit Timer 1)
    TIMER2_IRQHandler,            // 18 - CT32B0 (32-bit Timer 0)
    TIMER3_IRQHandler,            // 19 - CT32B1 (32-bit Timer 1)
