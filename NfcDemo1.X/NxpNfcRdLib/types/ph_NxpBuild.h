 ...
 * $Revision: 6156 $ (v4.040.05.011646)
 * $Date: 2016-09-23 18:04:23 +0530 (Fri, 23 Sep 2016) $
 *
 * History:
 *  MK: Generated 15. October 2009
 *  Zhiyuan Wang: Modified on 2018-04-18
 *
 */
...
#define NXPBUILD_CUSTOMER_HEADER_INCLUDED // added by zhiyuan



#ifdef NXPBUILD_CUSTOMER_HEADER_INCLUDED
    //#include <ph_NxpBuild_App.h>
    #include <ph_NxpBuild_PIC32MX_PN5180.h>
...
/* modified by zhiyuan */
#if defined (NXPBUILD__PHBAL_REG_PIC32MX_SPI) || \
    defined (NXPBUILD__PHBAL_REG_LPCOPEN_SPI) || \
    defined (NXPBUILD__PHBAL_REG_LPCOPEN_I2C) || \
    defined (NXPBUILD__PHBAL_REG_KINETIS_SPI) || \
    defined (NXPBUILD__PHBAL_REG_KINETIS_I2C) || \
    defined (NXPBUILD__PHBAL_REG_LINUX_KERNEL_SPI) || \
    defined (NXPBUILD__PHBAL_REG_LINUX_USER_SPI) || \
    defined (NXPBUILD__PHBAL_REG_LINUX_USER_I2C)
...
/* SNEP components */
    ...
    #define NXPBUILD__PH_KINETIS               /**< Kinetis */
#endif
