...
* $Revision: 6122 $ (v4.040.05.011646)
* $Date: 2016-09-23 12:11:29 +0530 (Fri, 23 Sep 2016) $
*
* History:
...
*  \brief Discovery loop component as per NFC Forum Activity Specification 1.1 and EMVCo Digital 2.5 specification.
*
*  Discovery loop implements poll mode based on NFC Activity Specification 1.1
*  (backward compatibility with version 1.0) and EMVCo Specification 2.5. Listen
