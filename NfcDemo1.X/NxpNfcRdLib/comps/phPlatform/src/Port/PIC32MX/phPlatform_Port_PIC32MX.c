...
/** \file
* Platform file abstracting HOST features for PIC32MX MCU.
...
phStatus_t phPlatform_Port_Host_SetPinConfig(phPlatform_Port_Host_config_t bConfig)
{
    ...
    case PHPLATFORM_PORT_PIN_RESET:
        /*
         * Configure PIC32MX pin to Output which is connected to Reset/PowerDown pin of the Front-end.
    ...
    case PHPLATFORM_PORT_PIN_IRQ:
        ...
        /* Configure the PIC32MX GPIO pin connected to IRQ pin of reader IC as input pin */
...
//        }
    ...
    case PHPLATFORM_PORT_PIN_DWL:
        ...
        /* DWL_REQ is low and keeps low forever */
        RF_DWL_REQ_SetLow();
...
bool phPlatform_Port_Host_GetPinValue(phPlatform_Port_Host_config_t bConfig)
{
    ...
    {
    case PHPLATFORM_PORT_PIN_IRQ:
        // pinStatus = Chip_GPIOINT_IsIntPending(LPC_GPIOINT, PORT_INTERRUPT);
        pinStatus = (bool)RF_IRQ_GetValue();
        break;
#ifdef NXPBUILD__PHHAL_HW_PN5180
    case PHPLATFORM_PORT_PIN_BUSY:
        // pinStatus = Chip_GPIO_GetPinState(LPC_GPIO, PORT_BUSY, PIN_BUSY);
        pinStatus = (bool)RF_BUSY_GetValue();
        break;
#endif
    default:
        break;
